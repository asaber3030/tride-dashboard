...
export const MergeSingleRideGroup = ({ selectedIds, onSelectId, group }: Props) => {
  return (
    <div onClick={() => onSelectId(group.id)} className={cn("border rounded-md mb-2 bg-white shadow-sm hover:shadow-md transition-shadow duration-200 cursor-pointer select-none", selectedIds.includes(group.id) ? "border-blue-500" : "border-gray-200")}>
