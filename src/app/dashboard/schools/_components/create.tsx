    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(handleAction)} className='space-y-4' noValidate>
        ...
        <div className='grid xl:grid-cols-2 grid-cols-1 gap-2'>
          <InputField name='lat' label={t("latitude")} field={form.register("lat")} error={form.formState?.errors?.lat} step='any' />
          <InputField name='lng' label={t("longitude")} field={form.register("lng")} error={form.formState?.errors?.lng} step='any' />
        </div>
