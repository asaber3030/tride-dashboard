...
export const SendMessages = ({ file, setFile, messageRef, handleKeyPress, handleSendMessage }: Props) => {
  return (
    <div className='p-4 border-t border-gray-200'>
      <div className='flex items-center bg-gray-100 rounded-full px-4 py-1'>
        <Input ref={messageRef} type='text' placeholder='Write your message' className='flex-1 border-0 bg-transparent focus-visible:ring-0 focus-visible:ring-offset-0' onKeyDown={handleKeyPress} />
